...
public class PCriteria {
	private Integer pCurrPage = 1;	//내가 있는 현재 페이지번호
	private Integer pAmount =  10;	//한 페이지에 보여줄 게시물개수
	...
	//그래서 return"redirect:/board/list?currPage"; 이런식으로 처리하는게 나아요
 	public String getPagingUri() {
		...
		builder.queryParam("currPage", this.pCurrPage);
		builder.queryParam("amount", this.pAmount);
