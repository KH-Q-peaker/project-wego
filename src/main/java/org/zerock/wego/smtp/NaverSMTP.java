...
import org.zerock.wego.domain.common.MailDTO;
...
public class NaverSMTP {
    ...
    public NaverSMTP() {
        ...
        auth = new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("네이버아이디", "아이디에맞는비번(2단계인증안해도되는임시비번)");
            }
        };
    }

    @GetMapping("/sendEmail")
    public String showMail(@SessionAttribute("__AUTH__") UserVO user, Model model) throws ControllerException {
        log.trace("showMail() invoked.");
        return "common/EmailSendMain";
    }
    ...
    public String sendMail(@ModelAttribute MailDTO mailDTO, Model model) {
        // code to send the email
        return "common/SendProcess";
    }
