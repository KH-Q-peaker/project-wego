...
public interface WithdrawMapper {
	...
	public abstract Integer deleteAlarmTableByMe(Integer userId);
	public abstract Integer deleteBadgeGetTableByMe(Integer userId);
	public abstract Integer deleteChatTableByMe(Integer userId);
	public abstract Integer deleteCommentTableByMe(Integer userId);
	public abstract Integer deleteJoinTableByMe(Integer userId);
	public abstract Integer deleteLikeTableByMe(Integer userId);
	public abstract Integer deleteReportTableByMe(Integer userId);
	public abstract Integer deleteSanPartyTableByMe(Integer userId);
	public abstract Integer deleteSanReviewTableByMe(Integer userId);
	public abstract Integer deleteUserTableByMe(Integer userId);
