...
public interface WithdrawMapper {
	...
	public abstract String seleteMyProfileImagePath(Integer userId);

	// 회원 탈퇴 2. 모집게시판에서 내가 올린 파일 조회
	public abstract String seleteMyPartyImagePath(Integer userId);
	
	// 회원 탈퇴 3. 리뷰게시판에서 내가 올린 파일 조회
	public abstract String seleteMyReviewImagePath(Integer userId);
