...
<div class="comments mention">
	<input type="hidden" id="commentId" value="${comment.commentId }" /> <input
		type="hidden" id="mentionId" value="${comment.mentionId }" /> <img
		class="cmtuserPic" src="${comment.userPic }" /> <a class="cmtuser"
		href="http://localhost:8080/profile/${comment.userId }">${comment.nickname}</a>
	<div class="cmtdate">
	...
	<div class="btns">
		...
		<c:if test="${comment.userId == sessionScope.__AUTH__.userId}">
			<!--  이거 조건 바꿔야된다!!!! -->
