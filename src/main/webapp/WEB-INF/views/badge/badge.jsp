				...
				<div class="badge">
					<div class="head">
						<span class="title boxStyle">
							<div class="boxName">
								<span id="svg"></span> <span id="targetUserName">${targetUserNickname}</span>
								<span>의 뱃지</span> <span id="svg"></span>
							</div>
						</span> <span class="pick5Setting">
							<button type="button">
								<span id="svg"></span>
							</button> <dialog id="setting">
							<div class="settingTitle">대표선택</div>
							<div class="settingError">대표뱃지는 5개까지만 설정 가능합니다</div>
							<!-- badge pick setting -->
							<div class="badgeBox" id="setting"></div>
							<div class="modalBtn">
								<form method="dialog">
