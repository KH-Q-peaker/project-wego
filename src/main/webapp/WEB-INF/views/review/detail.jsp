...
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/review-detail.css">
...
<script type="text/javascript"
	src="${path}/resources/js/review-detail.js" defer></script>
			...
			<div class="rheader">
				...
				<div class="dt">
					<fmt:formatDate pattern="yy-MM-dd HH:mm"
						value="${review.createdDt}"></fmt:formatDate>
				</div>
			</div>
			<div class="contents">
				<img src="${userPic}" alt="" class="userpic" /> <a class="username"
					href="http://localhost:8080/profile/${review.userId}">${review.nickName}</a>
				<div class="likeCnt">
					<input class="like ${isLike ? 'fill' : '' }" type="button" value="" />︎<label>
						${review.likeCnt }</label>
				</div>
