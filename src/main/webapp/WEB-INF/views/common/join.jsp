...
<body>
	<div class="joinModal">
		...
		<ul class="joinInfo">
			<li>날짜 : <fmt:formatDate pattern="yy-MM-dd"
					value="${party.partyDt}"></fmt:formatDate></li>
			<li>시간 : <fmt:formatDate pattern="HH:mm"
					value="${party.partyDt}"></fmt:formatDate></li>
		...
		<div class="button">
			<input type="button" class="clsbtn" value="취소" /> <input
				type="button" class="joinbtn" value="참여" />
		</div>
	</div>
</body>
</html>