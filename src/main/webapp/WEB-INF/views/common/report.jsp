...
<script type="text/javascript"
	src="${path}/resources/js/report.js?ver=1" defer></script>
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/report.css" />

<div class="reportModal">
	<input type="hidden" id="targetGb" name="targetGb" value="" /> <input
		type="hidden" id="targetCd" name="targetCd" value="" />
	...
	<ul class="reasons">
		...
		<li class="check"><input type="radio" name="check" value="불법"
			id="r2" /> <label for="r2" class="reason">불법 정보를 포함하고 있습니다.</label>
			<span>✓</span></li>
		...
		<li class="check"><input type="radio" name="check" value="개인정보"
			id="r5" /> <label for="r5" class="reason">개인정보 노출 게시물입니다.</label><span>✓</span>
		</li>
