...
window.onload = function(){
		...
		$.ajax({
	        ...
	        data:{"aCurrPage":aCurrPage,"aAmount":aAmount,"pCurrPage":pCurrPage,"pAmount":pAmount,"userId":userId},
	        success: function(data){
	            $("#module").load("/profile/partyList?aCurrPage="+aCurrPage + "&aAmount="+aAmount+ "&pCurrPage="+pCurrPage + "&pAmount="+pAmount+"&userId="+ userId);
	        }
	   });
   //}
};
